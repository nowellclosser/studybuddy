...
CREATE TABLE IF NOT EXISTS book_sections (
    ...
    reading_card_id TEXT,
    notes_card_id TEXT,
    exercises_card_id TEXT,
    ...
    PRIMARY KEY(book_id, chapter, section)
);
"""
...
for book_id, divisions in sections.items():
    for chapter, sections in divisions.items():
        if sections:
            ...
            section_values.append((book_id, chapter, None))
...
SET reading_completed=1,
    ...
    scheduled=1
WHERE book_id = '{common.STRANG_LA}' AND chapter <= 6
"""

update_pinter_read = f"""
UPDATE book_sections
SET reading_completed=1
WHERE book_id = '{common.PINTER_AA}' AND chapter <= 13
"""

update_pinter_exercises = f"""
UPDATE book_sections
SET exercises_completed=1
WHERE book_id = '{common.PINTER_AA}' AND chapter <= 12
"""
...
SET notes_completed=1,
    scheduled=1
WHERE book_id = '{common.PINTER_AA}' AND chapter <= 9
"""
